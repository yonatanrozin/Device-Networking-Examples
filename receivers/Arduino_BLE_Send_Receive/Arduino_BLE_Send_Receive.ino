...
char BLECharacteristic3UUID[] = "42345678-1234-abcd-1234-12345678abcd";
...
BLEFloatCharacteristic characteristic3(BLECharacteristic3UUID, BLERead | BLENotify | BLEWriteWithoutResponse); 
...
void loop(){ 
  ...
  if (millis() % 1000 < 30) {
    characteristic3.writeValue((float)random(0, 100) / 100.0);
    delay(20);
  }
